...
import { A as isResolvedRedirect, D as resolveManifestCssLink, E as resolveManifestAssetLink, M as isNotFound, O as executeRewriteInput, P as invariant, T as getStylesheetHref, a as replaceSsrResponse, i as normalizeSsrResponse, j as rootRouteId, k as isRedirect, n as defineHandlerCallback, o as stripSsrResponseBody, r as isSsrResponse, t as renderRouterToStream, u as RouterProvider, w as getScriptPreloadAttrs } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B_-_W_m2.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DW8__k97.mjs"),
		import("./start-C4PLjrr0.mjs"),
